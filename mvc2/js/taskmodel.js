...
//         console.log("model adding task");
         this.tasks.push({
             taskName: task,
             taskStatus: 'uncompleted'
         });
         this.addTaskEvent.notify(this.tasks);
     },
...
//             console.log("setting to complete index: " + index);
         ...
         this.setTasksAsCompletedEvent.notify(this.tasks);
     ...
     deleteTasks: function () {
         ...
         this.deleteTasksEvent.notify(this.tasks);
